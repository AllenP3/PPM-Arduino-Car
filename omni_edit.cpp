...
#define LeftMotorDirPin1B A2    //Rear Left Motor direction pin 1 to Left  MODEL-X IN3  (K3)
#define LeftMotorDirPin2B A3  //Rear Left Motor direction pin 2 to Left  MODEL-X IN4 (K3)
